...
%token ELSE IF INPUT INT OUTPUT RETURN VOID WHILE WRITE ASSIGN SEMI COMMA LPAREN RPAREN LBRACK RBRACK LBRACE RBRACE NUM ID STRING
%left LT EQ LE NEQ GT GE
%left PLUS MINUS
%left TIMES OVER 
%start program
%%
...
|	ID LBRACK {check_var(); $1 = new_node(CVAR_NODE, lookup_var(vt, yytext2,scope)); } ID { $4 = new_node(SVAR_NODE, lookup_var(vt, yytext2,scope)); } RBRACK { add_child($1,$4), $$ = $1; }
;
